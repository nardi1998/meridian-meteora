...
export function evolveThresholds(perfData, config) {
  ...
  // ── 1. maxVolatility ─────────────────────────────────────────
  // HARDCODED — do not evolve. Value is set in config.js and user-config.json only.
  // if (config.screening.maxVolatility != null) {
  //   Evolution logic removed to prevent auto-adjustment.
  // }
  ...
  // if (changes.maxVolatility    != null) s.maxVolatility    = changes.maxVolatility; // HARDCODED — do not evolve
