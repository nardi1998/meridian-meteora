...
Screening: screeningSource, minFeeActiveTvlRatio, minTvl, maxTvl, minVolume, minOrganic, minQuoteOrganic, minHolders, minMcap, maxMcap, minBinStep, maxBinStep, timeframe, category, minTokenFeesSol, excludeHighSupplyConcentration, useDiscordSignals, discordSignalMode, avoidPvpSymbols, blockPvpSymbols, allowedLaunchpads, blockedLaunchpads, minTokenAgeHours, maxTokenAgeHours, athFilterPct, athFilterPctSmallCap

⚠️ HARDCODED (cannot be changed by agent):
Screening: maxVolatility: 8, maxBundlePct: 30, maxBotHoldersPct: 35, maxTop10Pct: 40, gmgnMaxPhishingWalletPct: 0.3
Cooldown: oorCooldownTriggerCount: 3, oorCooldownHours: 3, repeatDeployCooldownEnabled: true, repeatDeployCooldownTriggerCount: 3, repeatDeployCooldownHours: 0.5, repeatDeployCooldownScope: "token", repeatDeployCooldownMinFeeEarnedPct: 0
